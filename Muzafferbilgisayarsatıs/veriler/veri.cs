...
namespace Muzafferbilgisayarsatıs.veriler
{
    public static class veri
    {
        ...
        public static int MüşteriEkle(Musteri m)
        {
            ...
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("bilgisayar_MusteriEkle", conn);
        ...
        internal static int MüşteriSil(string id)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("bilgisayar_MusteriSil", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static int MüşteriGüncelle(Musteri m)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("bilgisayar_MusteriGuncelle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
                komut.Parameters.AddWithValue("@id", m.ID);
                komut.Parameters.AddWithValue("@ad", m.Ad);
                komut.Parameters.AddWithValue("@soy", m.Soyad);
        ...
        internal static int UrunSil(string id)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("bilgisayar_UrunSil", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
                komut.Parameters.AddWithValue("@id", id);
        ...
        internal static int SatisSil(string id)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("bilgisayar_SatisSil", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
                komut.Parameters.AddWithValue("@id", id);
        ...
        internal static int UrunGüncelle(Urun u)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("bilgisayar_UrunGuncelle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static DataSet MüşteriGetir(string filtre)
        {
            try
            {
                ...
                {
                    komut = new MySqlCommand("bilgisayar_MusterilerHepsi", conn);
                    komut.CommandType = System.Data.CommandType.StoredProcedure;
                }
                else
                {
                    komut = new MySqlCommand("bilgisayar_MusteriBul", conn);
                    komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static int UrunEkle(Urun u)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("bilgisayar_UrunEkle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
                komut.Parameters.AddWithValue("@id", u.ID);
                komut.Parameters.AddWithValue("@ad", u.Ad);
                komut.Parameters.AddWithValue("@kategori", u.Kategori);
        ...
        internal static DataSet UrunGetir(string filtre)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(filtre))
                {
                    komut = new MySqlCommand("bilgisayar_UrunlerHepsi", conn);
                    komut.CommandType = System.Data.CommandType.StoredProcedure;
                }
                else
                {
                    komut = new MySqlCommand("bilgisayar_UrunBul", conn);
                    komut.CommandType = System.Data.CommandType.StoredProcedure;
                    komut.Parameters.AddWithValue("@filtre", filtre);
                }
        ...
        internal static int SatisEkle(Satis s)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("bilgisayar_SatisEkle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static int OdemeEkle(Odeme o)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("bilgisayar_OdemeEkle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static int OdemeGüncelle(Odeme o)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("bilgisayar_OdemeGuncelle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
                komut.Parameters.AddWithValue("@oid", o.ID);
                komut.Parameters.AddWithValue("@mid", o.MusteriID);
                komut.Parameters.AddWithValue("@tarih", o.Tarih);
        ...
        internal static int SatisGüncelle(Satis s)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("bilgisayar_SatisGuncelle", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
                komut.Parameters.AddWithValue("@sid", s.ID);
                komut.Parameters.AddWithValue("@mid", s.MusteriID);
                komut.Parameters.AddWithValue("@uid", s.UrunID);
        ...
        internal static DataSet SatisDeyat()
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("bilgisayar_SatisDetay", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static DataSet OdemeDetay()
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("bilgisayar_OdemeDetay", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        internal static int OdemeSil(string id)
        {
            try
            {
                ...
                MySqlCommand komut = new MySqlCommand("bilgisayar_OdemeSil", conn);
                komut.CommandType = System.Data.CommandType.StoredProcedure;
