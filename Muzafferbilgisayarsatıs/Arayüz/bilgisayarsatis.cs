...
using Muzafferbilgisayarsatıs.ayrıntılar;
using Muzafferbilgisayarsatıs.UI;
...
namespace Muzafferbilgisayarsatıs
{
    public partial class AnaForm : Form
    {
        ...
        {
            DataSet ds1 = ayrıntı.SatisDetay();
            if (ds1 != null)
                dataGridView1.DataSource = ds1.Tables[0];


            DataSet ds2 = ayrıntı.OdemeDetay();
            if (ds2 != null)
        ...
        tekrar:
            ...
            {
                bool b = ayrıntı.SatisEkle(frm.Satis);
        ...
        private void btnSatışDüzenle_Click(object sender, EventArgs e)
        {
            ...
            if (sonuc == DialogResult.OK)
            {
                bool b = ayrıntı.SatisGüncelle(frm.Satis);
        ...
        private void btnSatışSil_Click(object sender, EventArgs e)
        {
            ...
            if (sonuc == DialogResult.OK)
            {
                bool b = ayrıntı.SatisSil(ID);

                if (b)
                {

                    DataSet ds = ayrıntı.SatisDetay();
                    if (ds != null)
        ...
        tekrar:
            ...
            if (sonuc == DialogResult.OK)
            {
                bool b = ayrıntı.OdemeEkle(frm.Odeme);
        ...
        private void btnÖdemeDüzenle_Click(object sender, EventArgs e)
        {
            ...
            if (sonuc == DialogResult.OK)
            {
                bool b = ayrıntı.OdemeGüncelle(frm.Odeme);
        ...
        private void btnÖdemeSil_Click(object sender, EventArgs e)
        {
            ...
            if (sonuc == DialogResult.OK)
            {
                bool b = ayrıntı.OdemeSil(ID);

                if (b)
                {

                    DataSet ds = ayrıntı.OdemeDetay();
                    if (ds != null)
