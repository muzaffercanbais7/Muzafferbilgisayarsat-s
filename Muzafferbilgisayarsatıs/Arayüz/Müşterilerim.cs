...
namespace Muzafferbilgisayarsatıs.UI
{
    public partial class Müşteriler : Form
    {
        ...
        tekrar:
            ...
            {
                bool b = ayrıntı.MüşteriEkle(frmMusteri.Musteri);

                if (b)
                {

                    DataSet ds = ayrıntı.MüşteriGetir("");
                    if (ds != null)
        ...
        private void btnMüşteriDüzenle_Click(object sender, EventArgs e)
        {
            ...
            if (sonuc == DialogResult.OK)
            {
                bool b = ayrıntı.MüşteriGüncelle(frmMusteri.Musteri);
        ...
        {
            DataSet ds = ayrıntı.MüşteriGetir(toolStripTextBox1.Text);
            if (ds != null)
                dataGridView1.DataSource = ds.Tables[0];
        ...
        {
            DataSet ds1 = ayrıntı.MüşteriGetir("");
            if (ds1 != null)
